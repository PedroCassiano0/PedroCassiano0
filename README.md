...
Estou em transição de carreira para a tecnologia, com o apoio da graduação em **Engenharia de Software**.
...
Projetos e exercícios práticos que documentam minha evolução como desenvolvedor.
...
→  Aprofundar em Python para desenvolvimento backend
→  Aprender sobre APIs REST e banco de dados na prática
→  Evoluir no JavaScript para integrar frontend e backend
...
<p align="center">
  <em>"Todo especialista já foi um dia um iniciante. A diferença está em não parar de construir."</em>
</p>
